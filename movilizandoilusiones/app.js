const erNombres = /^[a-zA-ZáéíóúñüÁÉÍÓÚÑ]+\s[a-zA-ZáéíóúñüÁÉÍÓÚÑ]+$/
const erApellidos = /^[a-zA-ZáéíóúñüÁÉÍÓÚÑ]+\s[a-zA-ZáéíóúñüÁÉÍÓÚÑ]+$/
const erCedula = /^[0-9]+$/
...
function enviar() {
    ...
    const dias = document.querySelectorAll('input[name="arrDisponible[]"]:checked').length;
